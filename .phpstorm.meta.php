...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.aliases.CreatureUtils' => 'string',
            'app.aliases.TextFormatter' => 'string',
            ...
            'filesystems.links./home/chazzer/projects/uc-archive/public/storage' => 'string',
...
'app.aliases.CreatureUtils','app.aliases.TextFormatter','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./home/chazzer/projects/uc-archive/public/storage','hashing.driver','hashing.bcrypt.rounds',
...
'ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ide-helper.macroable_traits','ide-helper.custom_db_types','logging.default',
...
'ignition.argument_reducers','breadcrumbs.view','breadcrumbs.files','breadcrumbs.unnamed-route-exception','breadcrumbs.missing-route-bound-breadcrumb-exception',
...
'ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','home','creatures.search',
'creatures.index','creatures.family.show','creatures.family.creature.show',);
        registerArgumentsSet('views', 
'components.article-link','components.content-section','components.creature-formatted-block','components.creature-nav','components.evolutionary-line',
'components.page','pages.creatures.family.creature.show','pages.creatures.family.show','pages.creatures.index','pages.creatures.search',
...
'APP_PORT','LOG_CHANNEL','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION',
...
'WWWGROUP','WWWUSER','SAIL_XDEBUG_MODE','SAIL_XDEBUG_CONFIG',);
