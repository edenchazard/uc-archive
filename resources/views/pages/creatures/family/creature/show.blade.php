        ...
        <div class="flex flex-row flex-wrap gap-3 justify-center">
            ...
            <div class="max-w-sm">
                <div class="flex flex-col gap-2">
                    ...
                    <p>Being a member of the {{$family->name}} family, its elemental type is {{ ucfirst($family->element->value) }} with a rarity rating of {{ ucfirst($family->rarity()) }}{!! $family->unique_rating > 0 ? " <span class='font-bold'>(".ucfirst($family->uniqueRating()).")</span>" : '' !!}.</p>
